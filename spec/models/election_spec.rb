  ...
  context 'working with the election date' do
    let(:election) do
      FactoryGirl.create(:election,
                         election_date: Date.parse('22 October 2014'))
    end
